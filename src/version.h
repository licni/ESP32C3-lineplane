// 版本流水號: r3 (2026-09-25) 帶螢幕板讀 manifest-oled.json
// 舊: r2 (2026-09-14) 板子改成逐段比版本數字,只有網站版本比較新才提示更新(GG:板子 .12,網站 .11 卻說有新版本)
...
// ============================================================================
#define FW_VERSION "2026.09.25.1"
...
// 兩種板子各讀各的 manifest(GG 2026-09-25):普通版 manifest.json(沿用),帶螢幕板 manifest-oled.json.
#include "pins_config.h"
#if BOARD_C3_OLED
#define FW_MANIFEST_NAME "manifest-oled.json"
#else
