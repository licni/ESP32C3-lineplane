...
| 情況 | 行為 |
|---|---|
| GPIO21 安全開關沒按下(或沒接,斷線) | 起飛程序會開始,但不會倒數,馬達不轉;按下開關(放穩前後都可以)才倒數 |
| 設定改了還沒儲存 | 拒絕起飛 |
...
起飛程序(推飛機,網頁開始,上電倒數)照常開始,**按下安全開關才開始倒數**;放穩前後按都可以,按一下就記住. 燈號:待機長亮,等待放穩/等安全開關慢閃,倒數快閃,飛行中熄滅,正常結束閃 2 下,撞擊斷電閃 3 下.
